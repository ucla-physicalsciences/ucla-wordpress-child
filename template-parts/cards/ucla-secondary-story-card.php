...
?>
<article class="ucla-card ucla-card__story-secondary h-entry post-<?php the_ID(); ?>" id="post-<?php the_ID(); ?>">
  <?php // Entry Meta ?>
  <figure>
...
<time class="ucla-card__date dt-published"
  ...
  <h3 class="ucla-card__title p-name"><a aria-label="<?php the_title(); ?>" class="ucla-card__title-link u-url" <?php echo $link_attrs; ?>
